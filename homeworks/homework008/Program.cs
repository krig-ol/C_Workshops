...
int size = InputInt("Введите число, задающее размеры двух матриц (колличество строк и столбцов): ");
int[,] matrixA = new int[size, size];
int[,] matrixB = new int[size, size];
int[,] matrixC = new int[size, size];
Console.WriteLine("Матрицы A и B могут быть перемножены, если они совместимы, в том смысле," + 
